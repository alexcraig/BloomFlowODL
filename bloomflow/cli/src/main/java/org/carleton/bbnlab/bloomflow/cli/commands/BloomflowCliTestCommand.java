 ...
 */
package org.carleton.bbnlab.bloomflow.cli.commands;
...
public class BloomflowCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BloomflowCliTestCommand.class);
    protected final BloomflowCliCommands service;

    public BloomflowCliTestCommand(final BloomflowCliCommands service) {
